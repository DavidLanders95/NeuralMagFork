    ...
    for vsymb in v:
        ...
        for symb in iexpr.free_symbols:
            ...
            if vspace == 'cg':
                ...
                condition = f"i>={vidx[0]} and i<Nx+{vidx[0]} and j>={vidx[1]} and j<Ny+{vidx[1]} and k>={vidx[2]} and k<Nz+{vidx[2]}"
            sidx = ','.join(([['i','j','k'][i] + ['','+1','-1'][j] if i < 3 else str(j) for i, j in enumerate(idx)]))
