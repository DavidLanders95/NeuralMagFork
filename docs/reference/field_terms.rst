...
Moreover, it provides a powerful just-in-time compiler that is able to turn the symbolic description of an energy contributions into efficient code for the computation of the energy and corresponding effective field.
...
In order to combine multiple field contributions to the total effective field, NeuralMag provide the :class:`TotalField` class that automatically adds up arbitrary field contributions and energies.
